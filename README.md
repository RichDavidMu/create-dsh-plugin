...
- **The version is the contract.** `@rdmu/create-dsh-plugin@0.1.3-alpha.2.rev.1`
  generates a project pinned to `@deepseek-ai/dsh-*@0.1.3-alpha.2` — exactly, no
...
`@rdmu/create-dsh-plugin@0.1.3-alpha.2.rev.1` generates a project pinned to
`@deepseek-ai/dsh-*@0.1.3-alpha.2` — exactly, no caret. There is no `--dsh-version`
