...
@deepseek-ai/dsh-tools@0.1.2-rc.1
  installed at   /path/node_modules/.pnpm/@deepseek-ai+dsh-tools@0.1.2-rc.1_<hash>/node_modules/@deepseek-ai/dsh-tools
  ...
  snapshot       /project/.dsh-source/dsh-v0.1.2-rc.1
```
...
one this project depends on. For `@deepseek-ai/dsh-tools@0.1.2-rc.1`:

```
https://github.com/deepseek-ai/deepseek-harness/tree/dsh-v0.1.2-rc.1/packages/core/tools
```
...
That is deliberate. `^0.1.2-rc.1` also admits `0.1.1-rc.3` and `0.1.1`, so a
